...
collect_provider_config() {
    ...
    case "$provider" in
        openrouter)
            ...
            read -rp "Model [nvidia/nemotron-3-super-120b-a12b:free]: " primary_model
            primary_model="${primary_model:-nvidia/nemotron-3-super-120b-a12b:free}"
            ;;
        ollama)
            echo ""
...
OPENROUTER_MODEL=${model:-nvidia/nemotron-3-super-120b-a12b:free}
OPENROUTER_MODEL_EXECUTOR=${model:-nvidia/nemotron-3-super-120b-a12b:free}
OPENROUTER_MODEL_VISION=nvidia/nemotron-nano-12b-v2-vl:free
OPENROUTER_MODEL_MEMORY=${model:-nvidia/nemotron-3-super-120b-a12b:free}
EOF
    fi
...
EOF
    ...
    case "$primary" in
        openrouter)
            ...
            echo "LLM_MODEL=${model:-nvidia/nemotron-3-super-120b-a12b:free}" >> "$AWP_ENV"
            ;;
        ollama)
            echo "" >> "$AWP_ENV"
            echo "# --- Active Model (used by AWP runtime) ---" >> "$AWP_ENV"
