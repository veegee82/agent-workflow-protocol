...
<!-- CLOSED -->
  ...
  <!-- CLOSED -> OPEN -->
  <line x1="160" y1="90" x2="316.0" y2="90.0" stroke="#c0392b" stroke-width="2"/>
  <polygon points="318.0,90.0 312.0,93.0 312.0,87.0" fill="#c0392b"/>
  <text x="240" y="82" text-anchor="middle" fill="#c0392b" font-size="11">failure_threshold reached</text>
  <!-- OPEN -> HALF-OPEN -->
  <line x1="380" y1="120" x2="311.7" y2="159.0" stroke="#d4a017" stroke-width="2"/>
  <polygon points="310.0,160.0 313.7,154.4 316.7,159.6" fill="#d4a017"/>
  <text x="380" y="148" text-anchor="start" fill="#d4a017" font-size="11">reset_timeout</text>
  <!-- HALF-OPEN -> CLOSED (success) -->
  <line x1="185" y1="175" x2="121.5" y2="121.3" stroke="#27ae60" stroke-width="2"/>
  <polygon points="120.0,120.0 126.5,121.6 122.6,126.2" fill="#27ae60"/>
  <text x="110" y="158" text-anchor="end" fill="#27ae60" font-size="11">success</text>
  <!-- HALF-OPEN -> OPEN (failure) -->
  <line x1="315" y1="175" x2="378.5" y2="121.3" stroke="#c0392b" stroke-width="2"/>
  <polygon points="380.0,120.0 377.4,126.2 373.5,121.6" fill="#c0392b"/>
  <text x="385" y="158" text-anchor="start" fill="#c0392b" font-size="11">failure</text>
  <!-- CLOSED self-loop label -->
  <path d="M 60 70 C 40 30, 140 30, 120 70" fill="none" stroke="#27ae60" stroke-width="1.5"/>
