...
No agent can exercise a capability for which the system has not established the corresponding safety mechanism. This is not a guideline — it is enforced by the validator (rules R1–R26) and the compliance checker.
