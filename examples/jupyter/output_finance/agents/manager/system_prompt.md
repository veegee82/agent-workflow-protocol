...
- **stock_data** (dataframe) — file: `inputs/stock_data.csv`
  Preview: DataFrame 750 rows x 7 cols
  Shape: 750 rows x 7 cols
  Columns: Date (datetime64[s]), Open (float64), High (float64), Low (float64), Close (float64), Volume (int64), Ticker (str)
- **portfolio_config** (dict) — file: `inputs/portfolio_config.json`
  Content: ```json
  {"tickers": ["AAPL", "MSFT", "GOOGL", "AMZN", "NVDA", "META"], "risk_free_rate": 0.05, "benchmark": "equal_weight", "initial_weights": {"AAPL": 0.1667, "MSFT": 0.1667, "GOOGL": 0.1667, "AMZN": 0.1667,...
  ```
