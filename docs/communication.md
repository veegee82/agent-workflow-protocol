...
<svg viewBox="0 0 420 120" xmlns="http://www.w3.org/2000/svg" font-family="system-ui, -apple-system, sans-serif" font-size="12">
  <defs><marker id="ar1" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6" fill="#4a6fa5"/></marker><marker id="ar2" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6" fill="#27ae60"/></marker></defs>
  ...
  <line x1="82" y1="60" x2="326" y2="60" stroke="#4a6fa5" stroke-width="1.5" marker-end="url(#ar1)"/>
  <text x="205" y="55" text-anchor="middle" fill="#4a6fa5" font-size="11">request (reply_to=A)</text>
  <line x1="328" y1="90" x2="84" y2="90" stroke="#27ae60" stroke-width="1.5" marker-end="url(#ar2)"/>
...
<svg viewBox="0 0 500 100" xmlns="http://www.w3.org/2000/svg" font-family="system-ui, -apple-system, sans-serif" font-size="12">
  <defs><marker id="ar3" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6" fill="#7b4ea3"/></marker></defs>
  ...
  <line x1="107" y1="48" x2="163" y2="48" stroke="#7b4ea3" stroke-width="1.5" marker-end="url(#ar3)"/>
  <line x1="307" y1="35" x2="363" y2="22" stroke="#7b4ea3" stroke-width="1.2" marker-end="url(#ar3)"/>
  <line x1="307" y1="48" x2="363" y2="48" stroke="#7b4ea3" stroke-width="1.2" marker-end="url(#ar3)"/>
  <line x1="307" y1="60" x2="363" y2="74" stroke="#7b4ea3" stroke-width="1.2" marker-end="url(#ar3)"/>
</svg>
...
<svg viewBox="0 0 500 50" xmlns="http://www.w3.org/2000/svg" font-family="system-ui, -apple-system, sans-serif" font-size="12">
  <defs><marker id="ar4" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6" fill="#4a6fa5"/></marker></defs>
  ...
  <line x1="92" y1="25" x2="128" y2="25" stroke="#4a6fa5" stroke-width="1.5" marker-end="url(#ar4)"/>
  <line x1="212" y1="25" x2="248" y2="25" stroke="#4a6fa5" stroke-width="1.5" marker-end="url(#ar4)"/>
  <line x1="332" y1="25" x2="368" y2="25" stroke="#4a6fa5" stroke-width="1.5" marker-end="url(#ar4)"/>
</svg>
...
<svg viewBox="0 0 480 120" xmlns="http://www.w3.org/2000/svg" font-family="system-ui, -apple-system, sans-serif" font-size="11">
  <defs><marker id="ar5" markerWidth="7" markerHeight="5" refX="7" refY="2.5" orient="auto"><path d="M0,0 L7,2.5 L0,5" fill="#4a6fa5"/></marker></defs>
  ...
  <line x1="92" y1="50" x2="158" y2="18" stroke="#4a6fa5" stroke-width="1.2" marker-end="url(#ar5)"/>
  <line x1="92" y1="55" x2="158" y2="55" stroke="#4a6fa5" stroke-width="1.2" marker-end="url(#ar5)"/>
  <line x1="92" y1="60" x2="158" y2="93" stroke="#4a6fa5" stroke-width="1.2" marker-end="url(#ar5)"/>
  <line x1="242" y1="18" x2="318" y2="50" stroke="#27ae60" stroke-width="1.2" marker-end="url(#ar5)"/>
  <line x1="242" y1="55" x2="318" y2="55" stroke="#27ae60" stroke-width="1.2" marker-end="url(#ar5)"/>
  <line x1="242" y1="93" x2="318" y2="60" stroke="#27ae60" stroke-width="1.2" marker-end="url(#ar5)"/>
</svg>
