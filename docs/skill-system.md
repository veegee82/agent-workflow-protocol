...
- [Validation rules](validation.md) R1-R18 (the strict rules)
...
After generating all files, the AI verifies compliance with rules R1-R18:
...
- **Rules are additive.** Extension rules (F1, D1, etc.) apply on top of R1-R18.
